...
export const fetchUserEvents = async (userId: number) => {
  ...
  try {
    const response = await fetch(
      `${API_BASE_URL}/api/eventos/summary-user/${userId}`,
      {
        method: "GET",
        headers: {
          Accept: "application/json",
...
export const fetchEventDetails = async (eventId: string) => {
  try {
    const response = await fetch(`${API_BASE_URL}/api/eventos/${eventId}`, {
      method: "GET",
      headers: {
        Accept: "application/json",
      },
...
export const fetchEventSummary = async (groupId: string, userId: number) => {
  try {
    const response = await fetch(
      `${API_BASE_URL}/api/eventos/summary/${groupId}?userId=${userId}`,
      {
        method: "GET",
        headers: {
          Accept: "application/json",
...
export const fetchEventParticipants = async (groupId: string) => {
  try {
    const response = await fetch(
      `${API_BASE_URL}/api/participantes/event/${groupId}`,
      {
        method: "GET",
        headers: {
          Accept: "application/json",
    ...
    console.error(
      `Error fetching participants for event ID ${groupId}:`,
      error
    );
    throw error;
  }
...
export const fetchEventParticipantExpenses = async (
  participantId: string,
  groupId: string
) => {
  try {
    const response = await fetch(
      `${API_BASE_URL}/api/gastos/participante/${participantId}/evento/${groupId}`,
      {
        method: "GET",
        headers: {
          Accept: "application/json",
...
export const fetchParticipantById = async (participantId: string) => {
  try {
    const response = await fetch(
      `${API_BASE_URL}/api/participantes/${participantId}`,
      {
        method: "GET",
        headers: {
          Accept: "application/json",
    ...
    console.error(
      `Error fetching participant with ID ${participantId}:`,
      error
    );
    throw error;
  }
